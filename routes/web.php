...
Route::resource('viajes','TripController')->names('trips');
...
Route::get('/viajes/{trip}/sign', 'TripController@sign')->name('trips.sign');
Route::patch('/viajes/{trip}/join', 'TripController@join')->name('trips.join');
