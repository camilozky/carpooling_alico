					...
					<form method="POST" action="{{ route('register') }}">
						...
						<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="CO2_emission_factor" type="text" placeholder="{{ __('CO2 emission factor') }}" class="form-control" name="CO2_emission_factor" readonly required autocomplete="CO2_emission_factor" autofocus>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="carbon_footprint" type="text" placeholder="{{ __('Carbon footprint') }}" class="form-control" name="carbon_footprint" readonly required autocomplete="carbon_footprint" autofocus>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="carbon_footprint_all_year" type="text" placeholder="{{ __('Carbon footprint Calculated at the end of the year') }}"  class="form-control" name="carbon_footprint_all_year" readonly required autocomplete="carbon_footprint_all_year" autofocus>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="vehicle" type="text" placeholder="{{ __('vehicle') }}" class="form-control" name="vehicle" readonly required autocomplete="vehicle" autofocus>
								</div>
							</div>
